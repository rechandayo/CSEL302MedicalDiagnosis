...
class MedicalDiagnosis:
    ...
    def create_widgets(self):
        ...
        self.symptoms_listbox = tk.Listbox(available_frame, listvariable=self.available_symptoms,
                                         selectmode=tk.SINGLE, height=25, width=40)  # Increased height and width
        self.symptoms_listbox.grid(row=0, column=0, sticky=(tk.W, tk.E, tk.N, tk.S))
        
        # Scrollbar for available symptoms
        ...
        self.selected_listbox = tk.Listbox(selected_frame, height=25, width=40)  # Increased height and width
        self.selected_listbox.grid(row=0, column=0, sticky=(tk.W, tk.E, tk.N, tk.S))
        
        # Scrollbar for selected symptoms
